...
MAJOR_TO_CLUSTER = {
    ...
    "Marketing Management":       ("BUSINESS & MANAGEMENT", "Marketing & Communication"),
    "Accounting":                  ("BUSINESS & MANAGEMENT", "Finance & Accounting"),
    "Gen Business Mgmt":           ("BUSINESS & MANAGEMENT", "General Business"),
    "Entrepreneurship":            ("BUSINESS & MANAGEMENT", "General Business"),
    "Operations Management":       ("BUSINESS & MANAGEMENT", "Operations & Analytics"),
    "Human Resources Management":  ("BUSINESS & MANAGEMENT", "General Business"),
    "Economics - Business":        ("BUSINESS & MANAGEMENT", "Economics"),
    "Real Estate Studies":         ("BUSINESS & MANAGEMENT", "Specialized Business"),
    "International Business":      ("BUSINESS & MANAGEMENT", "International Studies"),
    "Bus Admin - Communication":   ("BUSINESS & MANAGEMENT", "General Business"),
    "Family Business":             ("BUSINESS & MANAGEMENT", "General Business"),
    "Risk Management and Insurance": ("BUSINESS & MANAGEMENT", "Finance & Accounting"),
    "Org. Ethics & Compliance":    ("BUSINESS & MANAGEMENT", "General Business"),
    "Law & Compliance":            ("BUSINESS & MANAGEMENT", "Social Sciences"),
    "Legal Studies":               ("BUSINESS & MANAGEMENT", "Social Sciences"),
    "MBA":                         ("BUSINESS & MANAGEMENT", "General Business"),
    "Executive MBA":               ("BUSINESS & MANAGEMENT", "General Business"),
    "Health Care MBA":             ("BUSINESS & MANAGEMENT", "General Business"),
    "Data Analytics":              ("BUSINESS & MANAGEMENT", "Operations & Analytics"),
    "MS Operations & Supply Chain Mgmt": ("BUSINESS & MANAGEMENT", "Operations & Analytics"),
    "MS Business Analytics":       ("BUSINESS & MANAGEMENT", "Operations & Analytics"),
    "Data Science":                ("BUSINESS & MANAGEMENT", "Operations & Analytics"),
    "Leadership & Management":     ("BUSINESS & MANAGEMENT", "General Business"),
    "Leadership":                  ("BUSINESS & MANAGEMENT", "General Business"),
    "Technology Management":       ("BUSINESS & MANAGEMENT", "General Business"),
    "Software Management":         ("BUSINESS & MANAGEMENT", "General Business"),
    "Health Care Innovation":      ("BUSINESS & MANAGEMENT", "General Business"),
    "Liberal Arts":                ("BUSINESS & MANAGEMENT", "Humanities & Liberal Arts"),
    "U.S. Law":                    ("BUSINESS & MANAGEMENT", "Social Sciences"),
    ...
    "Actuarial Science":           ("NATURAL & HEALTH SCIENCES", "Physical Sciences"),
    "Neuroscience":                ("NATURAL & HEALTH SCIENCES", "Biological Sciences"),
    "Exercise Science":            ("NATURAL & HEALTH SCIENCES", "Health & Wellness"),
    "Biochemistry":                ("NATURAL & HEALTH SCIENCES", "Biological Sciences"),
    "Chemistry":                   ("NATURAL & HEALTH SCIENCES", "Physical Sciences"),
    "Public Health":               ("NATURAL & HEALTH SCIENCES", "Health & Wellness"),
    ...
    "Nursing":                     ("NATURAL & HEALTH SCIENCES", "Health & Wellness"),
    "Physics":                     ("NATURAL & HEALTH SCIENCES", "Physical Sciences"),
    "Geology":                     ("NATURAL & HEALTH SCIENCES", "Physical Sciences"),
    "Biology of Global Health":    ("NATURAL & HEALTH SCIENCES", "Health & Wellness"),
    "Health Promotion & Wellness": ("NATURAL & HEALTH SCIENCES", "Health & Wellness"),
    "Statistics":                  ("NATURAL & HEALTH SCIENCES", "Physical Sciences"),
    "Mathematics (Applied Track)": ("NATURAL & HEALTH SCIENCES", "Physical Sciences"),
    "Mathematics (Education Track)": ("NATURAL & HEALTH SCIENCES", "Physical Sciences"),
    "Mathematics (Pure Track)":    ("NATURAL & HEALTH SCIENCES", "Physical Sciences"),
    "Mathematics (Statistics Track)": ("NATURAL & HEALTH SCIENCES", "Physical Sciences"),
    ...
    "Psychology":                  ("SOCIAL SCIENCES & HUMANITIES", "Social Sciences"),
    "Political Science":           ("SOCIAL SCIENCES & HUMANITIES", "Social Sciences"),
    "Philosophy":                  ("SOCIAL SCIENCES & HUMANITIES", "Humanities & Liberal Arts"),
    ...
    "Criminal Justice":            ("SOCIAL SCIENCES & HUMANITIES", "Social Sciences"),
    "History":                     ("SOCIAL SCIENCES & HUMANITIES", "Humanities & Liberal Arts"),
    "English":                     ("SOCIAL SCIENCES & HUMANITIES", "English & Writing"),
    "English - Creative Writing":  ("SOCIAL SCIENCES & HUMANITIES", "Creative Writing"),
    "English - Professional Writing": ("SOCIAL SCIENCES & HUMANITIES", "English & Writing"),
    "Sociology":                   ("SOCIAL SCIENCES & HUMANITIES", "Social Sciences"),
    ...
    "Classical Civilization":      ("SOCIAL SCIENCES & HUMANITIES", "Humanities & Liberal Arts"),
    "Family Studies":              ("SOCIAL SCIENCES & HUMANITIES", "Social Sciences"),
    "Individualized":              ("SOCIAL SCIENCES & HUMANITIES", "Social Sciences"),
    "Creative Writing & Publishing": ("SOCIAL SCIENCES & HUMANITIES", "Creative Writing"),

    # ── COMMUNICATION & MEDIA ────────────────────────────────────────────
    "Communication Studies":       ("COMMUNICATION & MEDIA", "Communication Studies"),
    "Strategic Comm: Ad and PR":   ("COMMUNICATION & MEDIA", "Marketing & Communication"),
    "COJO Strategic Communications": ("COMMUNICATION & MEDIA", "Marketing & Communication"),
    "Journalism":                  ("COMMUNICATION & MEDIA", "Journalism & Media"),
    "Digital Media Arts":          ("COMMUNICATION & MEDIA", "Journalism & Media"),
    "COJO Journalism":             ("COMMUNICATION & MEDIA", "Journalism & Media"),
    "COJO Creative Multimedia":    ("COMMUNICATION & MEDIA", "Journalism & Media"),
    "COJO Interpersonal Comm":     ("COMMUNICATION & MEDIA", "Communication Studies"),
    "COJO Persuasion/Soc Influence": ("COMMUNICATION & MEDIA", "Communication Studies"),
    "Business Communication":      ("COMMUNICATION & MEDIA", "Communication Studies"),
    "Communication and Journalism": ("COMMUNICATION & MEDIA", "Journalism & Media"),
    "Strategic Communication":     ("COMMUNICATION & MEDIA", "Marketing & Communication"),

    # ── EDUCATION & SOCIAL SERVICES ──────────────────────────────────────
    "Social Work":                 ("EDUCATION & SOCIAL SERVICES", "Social Work"),
    "Elementary Education (K-6)":  ("EDUCATION & SOCIAL SERVICES", "Teacher Education"),
    "Middle/Secondary Education":  ("EDUCATION & SOCIAL SERVICES", "Teacher Education"),
    "Educational Studies":         ("EDUCATION & SOCIAL SERVICES", "Teacher Education"),
    "Acad Behavioral Strategist":  ("EDUCATION & SOCIAL SERVICES", "Teacher Education"),
    "Early Childhood Special Educ": ("EDUCATION & SOCIAL SERVICES", "Teacher Education"),
    "Autism Spectrum Disorders":   ("EDUCATION & SOCIAL SERVICES", "Teacher Education"),
    "K-12 Music Education":        ("EDUCATION & SOCIAL SERVICES", "Teacher Education"),
    "K-12 World Lang. & Cultures": ("EDUCATION & SOCIAL SERVICES", "Teacher Education"),
    "Teacher Preparation - K-12":  ("EDUCATION & SOCIAL SERVICES", "Teacher Education"),
    "Teacher Preparation-Elem K-6": ("EDUCATION & SOCIAL SERVICES", "Teacher Education"),
    "Teacher Preparation-Secondary": ("EDUCATION & SOCIAL SERVICES", "Teacher Education"),
    "Music Education":             ("EDUCATION & SOCIAL SERVICES", "Teacher Education"),
    "Educ Leadership & Learning":  ("EDUCATION & SOCIAL SERVICES", "Teacher Education"),
    "Educational Leadership & Admin": ("EDUCATION & SOCIAL SERVICES", "Teacher Education"),
    "Leadership In Student Affairs": ("EDUCATION & SOCIAL SERVICES", "Teacher Education"),
    ...
    "Publc Safety & Law Enfr Ldrshp": ("EDUCATION & SOCIAL SERVICES", "Social Sciences"),

    # ── ARTS, LANGUAGES & THEOLOGY ───────────────────────────────────────
    "Catholic Studies":            ("ARTS, LANGUAGES & THEOLOGY", "Arts & Theology"),
    "Theology":                    ("ARTS, LANGUAGES & THEOLOGY", "Arts & Theology"),
    "Pastoral Leadership":         ("ARTS, LANGUAGES & THEOLOGY", "Arts & Theology"),
    "Pastoral Ministry":           ("ARTS, LANGUAGES & THEOLOGY", "Arts & Theology"),
    "Music":                       ("ARTS, LANGUAGES & THEOLOGY", "Arts & Theology"),
    "Music - Business":            ("ARTS, LANGUAGES & THEOLOGY", "Arts & Theology"),
    "Music - Performance":         ("ARTS, LANGUAGES & THEOLOGY", "Arts & Theology"),
    "Art History":                  ("ARTS, LANGUAGES & THEOLOGY", "Arts & Theology"),
    ...
    "Regulatory Science":           ("NATURAL & HEALTH SCIENCES", "Health & Wellness"),
    "Mathematics":                  ("NATURAL & HEALTH SCIENCES", "Physical Sciences"),
    "Software Engineering":         ("ENGINEERING & TECHNOLOGY", "Computer Science & IT"),
    "Manufacturing Engineering":    ("ENGINEERING & TECHNOLOGY", "Engineering Disciplines"),
    "Systems Engineering":          ("ENGINEERING & TECHNOLOGY", "Engineering Disciplines"),
    "Information Technology":       ("ENGINEERING & TECHNOLOGY", "Computer Science & IT"),
